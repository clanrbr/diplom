 ...
 */
public class HTTPGETRegulation extends AsyncTask<String, Void, String> {
    private Exception exception;
    private ArrayList<CharSequence> regulationArray;
    public AsyncResponseRegulation delegate = null;

    private CircularProgressBar progressBar;
    private int asyncStarted;

    public HTTPGETRegulation(CircularProgressBar progressBar, int asyncStarted) {
    ...
    protected void onPostExecute(String result) {
        ...
        delegate.processGetRegulationFinish(regulationArray);
    }
}