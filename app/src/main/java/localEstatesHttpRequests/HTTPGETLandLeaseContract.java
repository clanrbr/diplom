 ...
 */
public class HTTPGETLandLeaseContract extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String result) {
            ...
            try {
                ...
                for(int i = 0, count = jsonArray.length(); i< count; i++) {
                    try {
                        ...
                        if ( jsonObject!=null ) {
                            landLeaseContractArray.add(jsonObject.getString("value"));
                        }
                    }
        ...
        delegate.processGetLandLeaseContractFinish(landLeaseContractArray);
